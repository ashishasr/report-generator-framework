package com.reportgenerator.datafactory.api;
...
import com.reportgenerator.datafactory.service.AddressDataValues;
import com.reportgenerator.datafactory.service.ContentDataValues;
import com.reportgenerator.datafactory.service.NameDataValues;
import com.reportgenerator.datafactory.serviceImpl.AddressDataValuesImpl;
import com.reportgenerator.datafactory.serviceImpl.ContentDataValuesImpl;
import com.reportgenerator.datafactory.serviceImpl.NameDataValuesImpl;
...
public final class DataFactory {
	...
	private NameDataValues nameDataValues = new NameDataValuesImpl();
	private AddressDataValues addressDataValues = new AddressDataValuesImpl();
	private ContentDataValues contentDataValues = new ContentDataValuesImpl();
	...
	public String getState() {
		return getItem(addressDataValues.getStates());
	}
	...
	public String getGender() {
		return getItem(nameDataValues.getGender());
	}
	...
	public String getYearPassout() {
		return getItem(contentDataValues.getYearPassOut());
	}
	...
	public String getOperatingYear() {
		return getItem(contentDataValues.getOperatingYear());
	}
	
	public String getAge() {
		return getItem(nameDataValues.getAges());
	}
	
	
	public String getInstituteNames() {
		return getItem(nameDataValues.getInstNames());
	}
	...
	public float getFloatNumber() {
		return getFloatNumberBetween(Integer.MIN_VALUE, Integer.MAX_VALUE);
	}
	 ...
	 * @return
	 */
	public float getFloatNumberBetween(int min, int max) {
		if (max < min) {
